...
After any successful edit, re-read that file before editing it again.
...
Self-check: compare the last line of content with the line immediately after end. If they match, extend end to include that line.
...
{"path":"src/app.ts","edits":[{"op":"insert_after","pos":"4#PM","content":"  if (!displayName) return \"hello.\";"}]}
Example insert_before using line 1 from the snippet:
{"path":"src/app.ts","edits":[{"op":"insert_before","pos":"1#VR","content":"import { logger } from \"./logger\";"}]}
